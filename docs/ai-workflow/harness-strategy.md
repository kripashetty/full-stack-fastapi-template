...
How we constrain and verify work from AI coding assistants, coding agents, and manual contributors on the Engineering Design Review Assistant.
...
| **Skills** | Repeatable issue workflows | [.skills/issue-author.md](../../.skills/issue-author.md), [.skills/issue-implementation.md](../../.skills/issue-implementation.md) |
...
5. Confirm branch and allowed paths
